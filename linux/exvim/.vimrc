...
" } DISABLE end 
nnoremap <unique> <silent> f :call exUtility#GotoBuffer('next')<CR>
nnoremap <unique> <silent> b :call exUtility#GotoBuffer('prev')<CR>
nnoremap <unique> <silent> OA :call exUtility#SwapToLastEditBuffer()<CR>
...
let g:ex_default_langs = ['c', 'cpp', 'make', 'sh', 'java']
...
let OmniCpp_SelectFirstItem = 2 " modified by fang 2012-8-13
...
" Other settings
"/////////////////////////////////////////////////////////////////////////////
"add by fang 2012-8-11
"set line wrap
set wrap

"--vim display after edit--"
"set t_ti= t_te=

"let vim can use alias
set shellcmdflag=-ic
"else
"set shellcmdflag=-c
