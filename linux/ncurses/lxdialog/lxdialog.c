...
jumperFn j_progress, j_snake, j_lxmenu;
...
static struct Mode modes[] =
{
    ...
    {"--progress", 4, 4, 1, j_progress},
    {"--snake", 4, 5, 1, j_snake},
    {"--lxmenu", 4, 4, 1, j_lxmenu},
    {NULL, 0, 0, 0, NULL}
};
...
\nBox options:\
\n\
\n  --menu      <text> <height> <width> <menu height> <default> <tag1> <item1>...\
\n  --checklist <text> <height> <width> <list height> <tag1> <item1> <status1>...\
\n  --radiolist <text> <height> <width> <list height> <tag1> <item1> <status1>...\
\n  --textbox   <file> <height> <width> <file>\
\n  --inputbox  <text> <height> <width> [<init>]\
\n  --yesno     <text> <height> <width> \
\n  --infobox   <text> <height> <width> \
\n  --msgbox    <text> <height> <width> \
\n  --progress  <width> \
\n  --snake     <height> <width> [<level>]\
\n  --lxmenu     <height> <width>\
\n", name, name);
    exit (-1);
}
...
int
j_progress (const char *t, int ac, const char * const * av)
{
    return dialog_progress (atoi(av[2]), atoi(av[3]));
}

int
j_snake (const char *t, int ac, const char * const * av)
{
    return dialog_snake (atoi(av[2]), atoi(av[3]), (ac==5)?atoi(av[4]):1);
}

int
j_lxmenu (const char *t, int ac, const char * const * av)
{
    return dialog_lxmenu (atoi(av[2]), atoi(av[3]));
}
