...
function g:exES_UpdateEnvironment() " <<<
    ...
    if exists ('g:exES_VimfilesDirName')
        ...
        let g:TagHighlightSettings['TagFileDirectory'] = g:exES_CWD.'/'.g:exES_vimfiles_dirname
        let g:TagHighlightSettings['TypesFileDirectory'] = g:exES_CWD.'/'.g:exES_vimfiles_dirname
        """"""""""""""""add by fang end"""""""""""""""""""""
