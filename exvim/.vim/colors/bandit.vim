...
" Comments are green
let ColourAssignment['Comment']         = {"GUIFG": '#00ff00',     "CTERMFG": 'DarkGreen',     "TERM":   'Bold'}
...
let ColourAssignment['DefinedName']     = {"CTERMFG" : 'Red',  "GUIFG": '#ee82ee',     "TERM":    'Underline'}
...
"hi Ignore ctermfg=Red guifg=grey20
